        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/vote" className="text-gray-400 hover:text-white transition-colors text-sm flex items-center space-x-2">
                  <span className="w-1 h-1 bg-blue-500 rounded-full"></span>
                  <span>Voting Portal</span>
                </a>
              </li>
              <li>
                <a href="/results" className="text-gray-400 hover:text-white transition-colors text-sm flex items-center space-x-2">
                  <span className="w-1 h-1 bg-purple-500 rounded-full"></span>
                  <span>Election Results</span>
                </a>
              </li>
              <li>
                <a href="/candidates" className="text-gray-400 hover:text-white transition-colors text-sm flex items-center space-x-2">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a href="/how-it-works" className="text-gray-400 hover:text-white transition-colors text-sm flex items-center space-x-2">
                  <span className="w-1 h-1 bg-green-500 rounded-full"></span>
                  <span>How It Works</span>
                </a>
              </li>
              <li>
                <a href="/faq" className="text-gray-400 hover:text-white transition-colors text-sm flex items-center space-x-2">
                  <span className="w-1 h-1 bg-blue-500 rounded-full"></span>
                  <span>FAQ</span>
                </a>
              </li>
              <li>
                <a href="/privacy" className="text-gray-400 hover:text-white transition-colors text-sm flex items-center space-x-2">
                  <span className="w-1 h-1 bg-purple-500 rounded-full"></span>
                  <span>Privacy Policy</span>
                </a>
              </li>
              <li>
                <a href="/terms" className="text-gray-400 hover:text-white transition-colors text-sm flex items-center space-x-2">
                  <span className="w-1 h-1 bg-yellow-500 rounded-full"></span>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+233302123456" className="text-gray-400 hover:text-white transition-colors text-sm">
                  +233 30 212 3456
                </a>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:elections@regent.edu.gh" className="text-gray-400 hover:text-white transition-colors text-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6">
              <a href="/sitemap" className="text-gray-500 hover:text-white text-sm transition-colors">
                Sitemap
              </a>
              <a href="/accessibility" className="text-gray-500 hover:text-white text-sm transition-colors">
                Accessibility
              </a>
              <a href="/report-issue" className="text-gray-500 hover:text-white text-sm transition-colors">
                Report Issue
              </a>
          ...
          <div className="text-center mt-6 pt-6 border-t border-gray-900">
            ...
            <p className="text-gray-500 text-xs mt-2">
              ...
              <a href="mailto:support@regentelections.edu.gh" className="text-blue-400 hover:text-blue-300 ml-1">
